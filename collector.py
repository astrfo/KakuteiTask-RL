...
class Collector:
    def __init__(self, sim, epi, results_dir_path, is_save_img=True):
        ...
        self.action_count_sim = np.zeros((self.epi, 2))
    ...
    def reset(self):
        ...
        self.action_count_epi = np.zeros((self.epi, 2))
    ...
    def collect_episode_data(self, e, Q, V, TD_Q, TD_V, action):
        ...
        self.action_count_epi[e, action] += 1
    ...
    def save_episode_data(self):
        ...
        self.action_count_sim += self.action_count_epi
    ...
    def save_simulation_data(self):
        ...
        self.action_count_sim /= self.sim
        self.save_csv_img()
    ...
    def save_csv_img(self):
        ...
        np.savetxt(f'{self.results_dir_path}action_count.csv', self.action_count_sim, delimiter=',')
    ...
    def save_img(self):
        ...
        self.sub_plot('action_rate', self.action_count_sim)
